...
We always use the latest version of TailwindCSS for all CSS. Additionally, Shoelace components are styled using their custom properties and utility classes.
...
- Use Shoelace's custom properties to theme components globally.
- Avoid inline styles; prefer utility classes or global styles.
- Example:

```html
<sl-button class="bg-primary text-white hover:bg-primary-dark">
  Click Me
</sl-button>
```
