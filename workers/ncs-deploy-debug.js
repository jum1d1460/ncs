/**
 * Cloudflare Worker con debugging para ncs-deploy
  ...
  async fetch(request, env) {
    ...
    try {
      ...
      if (env.WEBHOOK_SECRET) {
        ...
        console.log('No WEBHOOK_SECRET configured, skipping HMAC validation')
      }
...
/**
 * Validar HMAC signature usando Web Crypto API
 */
async function validateHMAC(body, signature, secret) {
  try {
    ...
    console.log('Generated digest:', digest.substring(0, 10) + '...')
