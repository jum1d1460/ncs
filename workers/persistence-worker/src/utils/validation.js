...
/**
 * Schema de validación para solicitudes de cita
 */
export const appointmentSchema = z.object({
  ...
  preferred_date: z
    .string({
      required_error: 'La fecha preferida es requerida',
    })
    .regex(
      /^\d{4}-\d{2}-\d{2}$/,
  ...
  preferred_time: z
    .enum(['morning', 'afternoon', 'evening', 'any'], {
      required_error: 'La hora preferida es requerida',
    }),
  ...
  urgency: z
    .enum(['low', 'normal', 'high'], {
      invalid_type_error: 'Urgencia inválida (debe ser: low, normal, o high)',
    })
    .optional()
    .default('normal'),
...
/**
 * Schema de validación para leads de tests
 */
export const leadSchema = z.object({
  ...
  test_type: z
    ...
    .min(2, 'El tipo de test debe tener al menos 2 caracteres')
    .max(100, 'El tipo de test no puede exceder 100 caracteres')
    .transform((val) => val.trim()),
...
/**
 * Valida los datos de solicitud de cita
 */
